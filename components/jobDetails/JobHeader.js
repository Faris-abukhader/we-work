  ...
  return (
    <div className='w-full pb-14 border-b-2 border-gray-100'>
        ...
        <div className='flex-row space-y-3 md:space-y-0 md:flex justify-start md:justify-between pt-8'>
            ...
            {session.data && (session.data?.user?.accountType != 'e') && <button className='p-3 flex justify-center items-center space-x-1 bg-blue-600 rounded-md text-white hover:bg-blue-700 hover:border'>
