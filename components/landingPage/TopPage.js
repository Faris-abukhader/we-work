...
export default function TopPage() {
  return (
    <div style={{ backgroundImage: 'url("/images/mainPageBackground.jpeg")' }} className={`bg-csutomLightPink bg-no-repeat bg-center bg-cover w-full h-screen`}>
      <div className='bg-blue-400 bg-opacity-40 w-full h-screen flex justify-center items-center'>
        <div className='w-full sm:w-9/12  sm:px-0 text-center  sm:space-y-0'>
          ...
          <div className='w-11/12 bg-gray-200 mx-auto rounded-md flex space-x-1 space-y-3 p-4 ring-8 ring-gray-50 ring-opacity-40 animate__animated animate__fadeInDown animate__slow'>
    ...
    // <>
    // <div className={`relative w-full h-[90vh] mb-40`}>
    //   <div style={{background:"#f3f4f5"}} className="h-[70vh]">
        
     
    //   </div>
    //   <img src='/illustrations/wave1.svg'/>
    // </div>    
    //     </>
