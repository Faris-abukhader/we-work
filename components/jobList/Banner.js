...
export default function Banner() {
  return (
    <div className={`w-full h-[300px] px-2 flex justify-center`} >
        <div style={{background:'#f3f6fc'}} className={`w-full  rounded-lg relative p-3 text-center`}>
            <h1 className='text-4xl pb-5'><span className='text-blue-500'>22 Jobs</span> Available Now</h1>
            ...
            <div className='absolute w-full  bottom-1/2 translate-y-1/2 z-50'>
